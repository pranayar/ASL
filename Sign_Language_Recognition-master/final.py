...
song = pyglet.media.load('C:/Users/Pranay/Downloads/Sign_Language_Recognition-master1/Sign_Language_Recognition-master/Letters_stash_for_sounds/instructions.mp3')
	#('instructions.mp3')

root = Tk()
root.title("ASL Translator Application")

im = Image.open('C:/Users/Pranay/Downloads/Sign_Language_Recognition-master1/Sign_Language_Recognition-master/Letters_stash_for_sounds/ASL.jpg')
...
def main():
	...
	while (cap.isOpened()):
		...
		# print "Its 2"
			...
			cv2.putText(img, "Hello There ! Callibrate by letter A", put_text_pos, font, 1, put_text_color, 2,
			            cv2.LINE_AA)
				...
				if solidity < 0.85:
					...
					if aspect_ratio < 1:
						...
						if angle_t < 20:
							...
							cv2.putText(img, "The Letter is :  D", put_text_pos, font, 1, put_text_color, 2,
							            cv2.LINE_AA)
							...
							cv2.putText(img, "The Letter is :  I", put_text_pos, font, 1, put_text_color, 2,
							            cv2.LINE_AA)
							...
							cv2.putText(img, "The Letter is :  J", put_text_pos, font, 1, put_text_color, 2,
							            cv2.LINE_AA)
					...
					if angle_t > 30 and angle_t < 100:
						...
						cv2.putText(img, "The Letter is :  U", put_text_pos, font, 1, put_text_color, 2,
						            cv2.LINE_AA)  #
		...
		# print equi_diameter
		print
		'Radius:', PI * radius * radius, "Area:", area
		print
		area_of_circle - area
		print
		"The solidity is:", solidity
		print
		"The aspect ratio is :", aspect_ratio
		print
		"The number of convexity defects are :", count_defects
		print
		"The extent is :", extent
		print
		"the angle is:", angle_t
		print
		'\033[91m' + "The area of effective circle is " + '\033[0m', area_of_circle - area
